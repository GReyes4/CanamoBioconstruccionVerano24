...
const FAQ = () => {
  ...
  const questions = [
    { question: "¿Qué trabajo se está realizando en el tema de investigación?", answer: "En el campo de la investigación, nos estamos enfocando en dos áreas cruciales: la zonificación agroecológica y la estabilización de semillas. 1. Zonificación Agroecológica: Este proceso implica determinar cuáles son las mejores zonas de México para el desarrollo óptimo de la planta de cáñamo, considerando aspectos técnicos, económicos, políticos, sociales y los riesgos implícitos. La zonificación nos permite identificar regiones con el entorno ideal para maximizar la productividad y sostenibilidad del cultivo. 2. Estabilización de semillas: Estamos trabajando en colaboración con la Universidad Autónoma Chapingo en el desarrollo de semillas estabilizadas. Además, estamos en proceso de negociación con empresas extranjeras para importar estas semillas a México, siguiendo estrictos protocolos de investigación. Este esfuerzo nos permitirá mejorar la calidad y consistencia de las semillas disponibles para los agricultores mexicanos, asegurando cultivos más robustos y productivos. Este trabajo no solo impulsa el avance científico y tecnológico en el sector agroindustrial del cáñamo, sino que también fortalece la capacidad de México para competir en el mercado global." },
    ...
    { question: "¿Cómo puedo sumarme como voluntario del proyecto de Bioconstrucción, se puede apoyar en línea?", answer: "Nos encantaría contar con tu participación en nuestro proyecto de Bioconstrucción. Para unirte como voluntario, tienes dos opciones: Registro en Línea: Puedes registrarte fácilmente visitando nuestra página de voluntariado aquí y solicitar una reunión para discutir los detalles de tu colaboración. Página Principal de la Asociación: También puedes visitar la página principal de nuestra asociación en www.ameec.org. Allí encontrarás un formulario de registro, y uno de los miembros de nuestro equipo se pondrá en contacto contigo para explicarte los beneficios y las formas en las que puedes colaborar con nosotros. Si prefieres colaborar en línea, también es posible. Tenemos mucho trabajo administrativo que requiere de tu apoyo y puedes contribuir significativamente desde cualquier lugar. Nos entusiasma la idea de trabajar contigo y estamos seguros de que tu apoyo será invaluable para el éxito de nuestros proyectos. ¡Tu participación puede marcar una gran diferencia!" },
    { question: "¿Cómo puedo financiar o hacer una donación al proyecto?", answer: "Estamos encantados de contar con tu apoyo para financiar o hacer una donación a nuestro proyecto. Tienes varias opciones para hacerlo: En Línea: Puedes realizar tu donación directamente desde nuestra página web en el apartado de donaciones. Haz tu donación aquí. Teléfono: Si prefieres hablar con alguien de nuestro equipo, puedes comunicarte al teléfono 333-498-8518. Estaremos encantados de asistirte y proporcionarte toda la información que necesites para apoyar nuestros proyectos. Tu generosidad es fundamental para el éxito de nuestras iniciativas, y estamos agradecidos por tu contribución. ¡Gracias por ayudar a hacer una diferencia!" },
...
Nos enorgullece el impacto positivo que estos programas están teniendo en las comunidades, y agradecemos tu interés en conocer más sobre nuestras iniciativas. ¡Juntos podemos hacer la diferencia! \
" },
